declare namespace NodeJS {
  interface ProcessEnv {
     ...
     */
    readonly NEXT_PUBLIC_BRAND_FAVICON_SVG_URL: string | undefined;
    /**
     * Optional SVG favicon URL used by `/api/logo` for `type=icon|favicon-*` when `theme=dark`.
     * Example: https://develari.com/favicon-dark.svg
     */
    readonly NEXT_PUBLIC_BRAND_FAVICON_DARK_SVG_URL: string | undefined;
