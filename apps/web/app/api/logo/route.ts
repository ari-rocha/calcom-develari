...
function resolveCustomFaviconUrl({ theme }: { theme?: string }) {
  const isDark = theme === "dark";
  return (
    (isDark ? process.env.NEXT_PUBLIC_BRAND_FAVICON_DARK_SVG_URL : undefined) ??
    process.env.NEXT_PUBLIC_BRAND_FAVICON_SVG_URL
  );
}
