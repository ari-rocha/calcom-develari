...
export const metadata = {
  icons: {
    icon: [
      { url: "/api/logo?type=favicon-32&theme=light", media: "(prefers-color-scheme: light)" },
      { url: "/api/logo?type=favicon-32&theme=dark", media: "(prefers-color-scheme: dark)" },
    ],
    ...
    other: [
      ...
      {
        url: "/api/logo?type=favicon-16&theme=light",
        sizes: "16x16",
      },
      {
        url: "/api/logo?type=favicon-32&theme=light",
        sizes: "32x32",
      },
    ],
  },
